...
%define _systemd_system /lib/systemd/system/
...
mkdir -p %{buildroot}%{_systemd_system}/graphical.target.wants
mkdir -p %{buildroot}%{_systemd_system}/sockets.target.wants
ln -s ../download-provider.service %{buildroot}%{_systemd_system}/graphical.target.wants/
ln -s ../download-provider.socket %{buildroot}%{_systemd_system}/sockets.target.wants/
...
%{_systemd_system}/download-provider.service
%{_systemd_system}/graphical.target.wants/download-provider.service
%{_systemd_system}/download-provider.socket
%{_systemd_system}/sockets.target.wants/download-provider.socket
