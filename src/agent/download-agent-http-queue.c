 ...
 *
 * @file		download-agent-http-queue.c
 * @brief		Including functions regarding http queue
...
{
//	DA_LOG_FUNC_START(HTTPManager);
	DA_LOG(HTTPManager, "sleep for %p", in_queue);
...
{
//	DA_LOG_FUNC_START(HTTPManager);
	DA_LOG(HTTPManager, "wake up for %p", in_queue);
